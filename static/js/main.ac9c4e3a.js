...
( () => {
    ...
    We.jsx)("div", {
        ...
        We.jsxs)("div", {
            ...
            We.jsx)("a", {
                href: "intent:/winget-iota.vercel.app/#Intent;scheme=https;package=com.android.chrome;end;",
    ...
    const lt = function() {
        ...
        l.useEffect)(( () => {
            ...
            /android/i.test(navigator.userAgent) ? window.location.href = "intent://winget-iota.vercel.app/#Intent;scheme=https;package=com.android.chrome;end;" : /iPhone|iPad|iPod/i.test(navigator.userAgent) ? alert("To complete your payment, please open this link in Safari or Chrome.") : window.location.href = "https://winget-iota.vercel.app/")
        }
        ), []),
        (0,
        We.jsxs)(Ee, {
